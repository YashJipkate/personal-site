export default function TechnicalExperiences() {
  return (
                  ...
                  <div>
                    <ul>
                      <li>
                        ...
                        architecture from AngularJS to Angular 8 in TypeScript.
                      </li>
                      <li>
                    ...
                    <div className="desc">
                      ...
                      <div className="absolute">
                        <div>
                          <ul>
                            <li>
                              Developed a responsive web-app for crowd-sourcing
                              information to track progress of construction
                              sites powered by gamification.
                            </li>
                            <li>
                        ...
                        <div>
                          <ul>
                            ...
                            <li>
                              ...
                              external theme integration, the site served as an
                              essential part of the organization and success of
                              the fest.
                            </li>
                            <li>
                              The Django backend equipped with swagger provided
                              a user friendly interface to visualize and consume
                              the Technex API.
                            </li>
                            <li>
                  ...
                  <div>
                    <ul>
                      ...
                      <li>
                        ...
                        tell’ (for image captioning) with the help of Tensorflow
                        and Keras.
                      </li>
                      <li>
