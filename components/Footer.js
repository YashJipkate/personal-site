      ...
      <div className="container">
        <div className="row mb-5">
          <div className="col-md">
            <div className="ftco-footer-widget mb-4">
              ...
              <p>
                If you have any complaints or suggestions, please feel free to reach out to me
                via any mode suitable. Also, find me on FB, Insta, GitHub, LinkedIn and Sourcerer.
              </p>
              ...
              <div className="block-23 mb-3">
                <ul>
                  <li>
                    ...
                    <span className="text">
                      Room 184, Visweswaraya Hostel, IIT(BHU), Varanasi, UP - 221005
                    </span>
                  </li>
                  <li>
        ...
        <div className="row">
          <div className="col-md-12 text-center">
            <p>
              Developed by Yash Jipkate in <a href="https://nextjs.org/">Next.js</a> | Template by <a href="https://colorlib.com/wp/template/evans/">Colorlib</a>
            </p>
          </div>
        </div>
      </div>
