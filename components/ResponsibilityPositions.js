export default function ResponsibilityPositions() {
  return (
                  ...
                  <div>
                    <ul>
                      <li>
                        ...
                        website of Technex, the Campus Ambassador portal and the
                        Hospitality portal.
                      </li>
                      <li>
                        Trained the juniors in Angular, Django and Heroku which
                        form the primary tech stack of the site.
                      </li>
                      <li>
                ...
                <div className="absolute">
                  <div>
                    <ul>
                      ...
                      <li>
                        Specialized in linter related issues, the python part of
                        which was in PyLint with some custom extensions.
                      </li>
                      <li>
